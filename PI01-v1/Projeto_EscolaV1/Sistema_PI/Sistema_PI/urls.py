...
urlpatterns = [
    ...
    path('aluno/editar/<str:id_aluno>/', views.editar_aluno, name='editar_aluno'), # Nova URL para editar
    path('aluno/excluir/<str:id_aluno>/', views.excluir_aluno, name='excluir_aluno'), # Nova URL para excluir
]
